    ...
    <main class="form-signin w-100 m-auto">
        <form id="form-login" method="post" action="auth.php">
            ...
            <div class="form-floating">
                <input type="text" class="form-control" id="admin-id" placeholder="Admin" name="employee-id" required>
                <label for="admin-id">Admin</label>
            </div>
            <div class="form-floating">
                <input type="password" class="form-control" id="admin-pass" placeholder="Password" name="employee-pass" required>
